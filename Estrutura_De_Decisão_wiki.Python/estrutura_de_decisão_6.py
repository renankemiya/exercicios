...
if numero_1 > numero_2:
    if numero_1 > numero_3:
        ...
        print(f'O primeiro e o terceiro são iguais: {numero_1}')
    else:
    ...
    if numero_2 > numero_1:
        ...
        print(f'O segundo e o primeiro são iguais: {numero_2}')
    else:
        print(f'O primeiro é o maior número: {numero_1}')
    ...
    if numero_3 > numero_2:
        ...
        print(f'O terceiro e o segundo são iguais: {numero_3}')
    else:
        print(f'O segundo é o maior número: {numero_2}')
else:
