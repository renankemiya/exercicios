...
if comprar == 'maças':
    ...
    if peso <= 5:
        ...
        print(f'O valor de {peso} Kg de maças é de {a_pagar} reais')
    else:
        a_pagar = peso * ma_preco_maior_5
        if peso > 8 or a_pagar > 25:
            desconto_total = a_pagar * 0.1
            total_a_pagar = a_pagar - desconto_total
            print(f'O valor de {peso} Kg de maças é de {total_a_pagar} reais')
        else:
            print(f'O valor de {peso} Kg de maças é de {a_pagar} reais')
    ...
    if peso <= 5:
        ...
        print(f'O valor de {peso} Kg de morangos é de {a_pagar} reais')
    else:
        a_pagar = peso * mo_preco_maior_5
        if peso > 8 or a_pagar > 25:
            desconto_total = a_pagar * 0.1
            total_a_pagar = a_pagar - desconto_total
            print(f'O valor de {peso} Kg de morangos é de {total_a_pagar} reais')
        else:
            print(f'O valor de {peso} Kg de morangos é de {a_pagar} reais')
elif comprar == 'ambos':
    ...
    if peso_total <= 5:
        ...
        print(f'{peso_total} Kg em maças e morangos irão custar {preco_total} reais')
    else:
        ...
        if peso_total > 8 or preco_total > 25:
            ...
            print(f'{peso_total} Kg em maças e morangos irão custar {preco_a_pagar} reais')
        else:
            print(f'{peso_total} Kg em maças e morangos irão custar {preco_total} reais')
